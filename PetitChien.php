 ...
 */
class PetitChien {
    /*mettre les propriétés du chien:
    *nom, race, dateNaissance, couleur
     */
        /*
    ...
    public function __toString() {
        return 'mon nom est '.$this->nom.', ma race est '.$this->race.', je suis né le '.$this->dateNaissance.', ma couleur est '.$this->couleur.'.';
    }
